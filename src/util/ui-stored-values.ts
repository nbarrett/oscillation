...
export enum StoredValue {
  ...
  GEOJSON_FEATURES = "geo-json-features",
  LAYER_GROUP = "layer-group",
  GEOJSON_FEATURES_CAPTURED = "geo-json-features-captured",
  FEATURE_REQUEST_INDEX = "feature-request-index",
  MAP_CENTRE_POSITION = "map-centre-position",
  MAP_CLICK_POSITION = "map-click-position",
  SELECTED_GRID_SQUARES = "selected-grid-squares",
  MAP_LAYER = "map-layer",
  MAP_ZOOM = "map-zoom",
  MAP_OPTIONS = "map-options",
  CRS = "crs",
  PLAYER_ZOOM_REQUEST     = "player-zoom-request",
  GRID_CLEAR_REQUEST = "grid-clear-request",
