...
export function FeatureDetails() {
    ...
    function findRoads() {
        ...
        const polygonString = gridSquareLatLongs.map(latlng => `${latlng.lat},${latlng.lng}`).join(',');
        log.info("findRoads:", polygonString);
        ...
        <ogc:Filter>
            ...
            <ogc:BBOX>
                ...
                <gml:Box srsName="EPSG:4326">
                    <gml:coordinates>${polygonString}</gml:coordinates>
                </gml:Box>
            </ogc:BBOX>
        </ogc:Filter>`;
